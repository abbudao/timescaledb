# DATE probe: variant `t3-after` @ 2085ee2

run_id `t3-after-2085ee2-20260922T113428Z`, scale `small`, TimescaleDB 2.31.0-dev on PostgreSQL 16.15 (Ubuntu 16.15-0ubuntu0.24.04.1), started 2026-09-22 11:34 UTC
...
|---|---|---:|---:|---:|---:|---|---:|---:|---:|---:|---:|
| Q1 | metrics_date | 6.03 | 0.49 | 5 | 0 | t | 1 | 144000 | 0 | 6025 | 0 |
| Q1 | metrics_tstz | 6.12 | 0.45 | 5 | 0 | t | 1 | 144000 | 0 | 6025 | 0 |
| Q2 | metrics_date | 5.44 | 0.34 | 5 | 0 | t | 1 | 148800 | 0 | 6025 | 0 |
| Q2 | metrics_tstz | 15.78 | 4.61 | 5 | 53 | t | 1 | 148800 | 2 | 6025 | 0 |
| Q3 | metrics_date | 4.94 | 0.35 | 5 | 0 | t | 1 | 148800 | 0 | 4225 | 0 |
| Q3 | metrics_tstz | 4.78 | 0.36 | 5 | 0 | t | 1 | 148800 | 0 | 4225 | 0 |
| Q4 | metrics_date | 22.05 | 0.54 | 5 | 0 | t | 1000 | 148800 | 0 | 9025 | 0 |
| Q4 | metrics_tstz | 16.31 | 0.43 | 5 | 0 | t | 1000 | 148800 | 0 | 9025 | 0 |
| Q5 | metrics_date | 0.04 | 0.18 | 1 | 0 | t | 24 | 24 | 0 | 23 | 0 |
| Q5 | metrics_tstz | 0.04 | 0.19 | 1 | 0 | t | 24 | 24 | 0 | 23 | 0 |

## Load, compression and continuous aggregate

| table | phase | seconds | rows | rows/sec |
|---|---|---:|---:|---:|
| metrics_date | cagg_refresh | 0.80 | 80000 | 99682 |
| metrics_tstz | cagg_refresh | 0.82 | 80000 | 97332 |
| metrics_date | compress | 2.17 | 1920000 | 886402 |
| metrics_tstz | compress | 2.10 | 1920000 | 914523 |
| metrics_date | load | 3.90 | 1920000 | 492396 |
| metrics_tstz | load | 4.89 | 1920000 | 392393 |

## Storage, whole table

| table | rows | heap before | index before | total before | bytes/row before | total after | bytes/row after | ratio |
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| metrics_date | 1920000 | 152 MB | 13 MB | 166 MB | 90.73 | 52 MB | 28.67 | 3.16 |
| metrics_tstz | 1920000 | 152 MB | 13 MB | 166 MB | 90.73 | 56 MB | 30.37 | 2.99 |
...
| metrics_date | status | text | 8959577 | 4.666 | 1314600 | 0.685 | 6.82 | 11600 | 165.5 |
| metrics_date | v1 | double precision | 15360000 | 8.000 | 13350080 | 6.953 | 1.15 | 11600 | 165.5 |
| metrics_date | v2 | double precision | 15360000 | 8.000 | 14837200 | 7.728 | 1.04 | 11600 | 165.5 |
| metrics_date | v3 | integer | 7680000 | 4.000 | 2658424 | 1.385 | 2.89 | 11600 | 165.5 |
| metrics_date | (columns) |  | 85759577 | 44.666 | 36182600 | 18.845 | 2.37 |  |  |
| metrics_date | (heap) |  | 159645696 | 83.149 | 6160384 | 3.209 | 25.91 |  |  |
| metrics_date | (index) |  | 14057472 | 7.322 | 950272 | 0.495 | 14.79 |  |  |
| metrics_date | (toast) |  | 475136 | 0.247 | 47931392 | 24.964 | 0.01 |  |  |
| metrics_date | (total) |  | 174178304 | 90.718 | 55042048 | 28.668 | 3.16 |  |  |
...
| metrics_tstz | status | text | 8959577 | 4.666 | 1314600 | 0.685 | 6.82 | 11600 | 165.5 |
| metrics_tstz | ts | timestamp with time zone | 15360000 | 8.000 | 2976200 | 1.550 | 5.16 | 11600 | 165.5 |
| metrics_tstz | v1 | double precision | 15360000 | 8.000 | 13350080 | 6.953 | 1.15 | 11600 | 165.5 |
| metrics_tstz | v2 | double precision | 15360000 | 8.000 | 14837200 | 7.728 | 1.04 | 11600 | 165.5 |
| metrics_tstz | v3 | integer | 7680000 | 4.000 | 2658424 | 1.385 | 2.89 | 11600 | 165.5 |
| metrics_tstz | (columns) |  | 93439577 | 48.666 | 38099400 | 19.843 | 2.45 |  |  |
| metrics_tstz | (heap) |  | 159645696 | 83.149 | 6160384 | 3.209 | 25.91 |  |  |
| metrics_tstz | (index) |  | 14057472 | 7.322 | 950272 | 0.495 | 14.79 |  |  |
| metrics_tstz | (toast) |  | 475136 | 0.247 | 51208192 | 26.671 | 0.01 |  |  |
| metrics_tstz | (total) |  | 174178304 | 90.718 | 58318848 | 30.374 | 2.99 |  |  |
