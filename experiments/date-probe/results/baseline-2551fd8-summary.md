# DATE probe: variant `baseline` @ 2551fd8

run_id `baseline-2551fd8-20260922T005123Z`, scale `small`, TimescaleDB 2.31.0-dev on PostgreSQL 16.15 (Ubuntu 16.15-0ubuntu0.24.04.1), started 2026-09-22 00:51 UTC
...
|---|---|---:|---:|---:|---:|---|---:|---:|---:|---:|---:|
| Q1 | metrics_date | 30.96 | 4.01 | 58 | 0 | f | 1 | 144000 | 2 | 6360 | 0 |
| Q1 | metrics_tstz | 5.82 | 0.46 | 5 | 0 | t | 1 | 144000 | 0 | 6025 | 0 |
| Q2 | metrics_date | 21.13 | 3.35 | 5 | 53 | t | 1 | 148800 | 2 | 6025 | 0 |
| Q2 | metrics_tstz | 20.16 | 4.49 | 5 | 53 | t | 1 | 148800 | 2 | 6025 | 0 |
| Q3 | metrics_date | 4.60 | 0.37 | 5 | 0 | t | 1 | 148800 | 0 | 4225 | 0 |
| Q3 | metrics_tstz | 4.69 | 0.36 | 5 | 0 | t | 1 | 148800 | 0 | 4225 | 0 |
| Q4 | metrics_date | 21.09 | 0.45 | 5 | 0 | t | 1000 | 148800 | 0 | 9025 | 0 |
| Q4 | metrics_tstz | 17.37 | 0.58 | 5 | 0 | t | 1000 | 148800 | 0 | 9025 | 0 |
| Q5 | metrics_date | 0.04 | 0.16 | 1 | 0 | t | 24 | 24 | 0 | 23 | 0 |
| Q5 | metrics_tstz | 0.04 | 0.17 | 1 | 0 | t | 24 | 24 | 0 | 23 | 0 |

## Load, compression and continuous aggregate

| table | phase | seconds | rows | rows/sec |
|---|---|---:|---:|---:|
| metrics_date | cagg_refresh | 0.77 | 80000 | 104525 |
| metrics_tstz | cagg_refresh | 0.78 | 80000 | 102591 |
| metrics_date | compress | 2.04 | 1920000 | 943081 |
| metrics_tstz | compress | 2.06 | 1920000 | 932892 |
| metrics_date | load | 3.95 | 1920000 | 485523 |
| metrics_tstz | load | 4.90 | 1920000 | 392088 |

## Storage, whole table

| table | rows | heap before | index before | total before | bytes/row before | total after | bytes/row after | ratio |
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| metrics_date | 1920000 | 152 MB | 13 MB | 166 MB | 90.73 | 53 MB | 28.76 | 3.15 |
...
| metrics_date | status | text | 8960056 | 4.667 | 1314600 | 0.685 | 6.82 | 11600 | 165.5 |
| metrics_date | v1 | double precision | 15360000 | 8.000 | 13351304 | 6.954 | 1.15 | 11600 | 165.5 |
| metrics_date | v2 | double precision | 15360000 | 8.000 | 14839688 | 7.729 | 1.04 | 11600 | 165.5 |
| metrics_date | v3 | integer | 7680000 | 4.000 | 2658576 | 1.385 | 2.89 | 11600 | 165.5 |
| metrics_date | (columns) |  | 85760056 | 44.667 | 36186464 | 18.847 | 2.37 |  |  |
| metrics_date | (heap) |  | 159653888 | 83.153 | 6160384 | 3.209 | 25.92 |  |  |
| metrics_date | (index) |  | 14057472 | 7.322 | 950272 | 0.495 | 14.79 |  |  |
| metrics_date | (toast) |  | 475136 | 0.247 | 48103424 | 25.054 | 0.01 |  |  |
| metrics_date | (total) |  | 174186496 | 90.722 | 55214080 | 28.757 | 3.15 |  |  |
...
| metrics_tstz | status | text | 8960056 | 4.667 | 1314600 | 0.685 | 6.82 | 11600 | 165.5 |
| metrics_tstz | ts | timestamp with time zone | 15360000 | 8.000 | 2976200 | 1.550 | 5.16 | 11600 | 165.5 |
| metrics_tstz | v1 | double precision | 15360000 | 8.000 | 13351304 | 6.954 | 1.15 | 11600 | 165.5 |
| metrics_tstz | v2 | double precision | 15360000 | 8.000 | 14839688 | 7.729 | 1.04 | 11600 | 165.5 |
| metrics_tstz | v3 | integer | 7680000 | 4.000 | 2658576 | 1.385 | 2.89 | 11600 | 165.5 |
| metrics_tstz | (columns) |  | 93440056 | 48.667 | 38103264 | 19.845 | 2.45 |  |  |
| metrics_tstz | (heap) |  | 159653888 | 83.153 | 6160384 | 3.209 | 25.92 |  |  |
| metrics_tstz | (index) |  | 14057472 | 7.322 | 950272 | 0.495 | 14.79 |  |  |
| metrics_tstz | (toast) |  | 475136 | 0.247 | 51208192 | 26.671 | 0.01 |  |  |
| metrics_tstz | (total) |  | 174186496 | 90.722 | 58318848 | 30.374 | 2.99 |  |  |
