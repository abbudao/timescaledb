# DATE probe: variant `int-after-guccheck` @ ac62b98

run_id `int-after-guccheck-ac62b98-20260922T115259Z`, scale `small`, TimescaleDB 2.31.0-dev on PostgreSQL 16.15 (Ubuntu 16.15-0ubuntu0.24.04.1), started 2026-09-22 11:53 UTC
...
|---|---|---:|---:|---:|---:|---|---:|---:|---:|---:|---:|
| Q1 | metrics_date | 6.13 | 0.83 | 5 | 0 | t | 1 | 144000 | 0 | 6025 | 0 |
| Q1 | metrics_tstz | 5.92 | 0.53 | 5 | 0 | t | 1 | 144000 | 0 | 6025 | 0 |
| Q2 | metrics_date | 5.74 | 0.37 | 5 | 0 | t | 1 | 148800 | 0 | 6025 | 0 |
| Q2 | metrics_tstz | 15.86 | 4.66 | 5 | 53 | t | 1 | 148800 | 2 | 6025 | 0 |
| Q3 | metrics_date | 4.81 | 0.45 | 5 | 0 | t | 1 | 148800 | 0 | 4225 | 0 |
| Q3 | metrics_tstz | 4.95 | 0.61 | 5 | 0 | t | 1 | 148800 | 0 | 4225 | 0 |
| Q4 | metrics_date | 22.61 | 0.56 | 5 | 0 | t | 1000 | 148800 | 0 | 9025 | 0 |
| Q4 | metrics_tstz | 16.84 | 0.51 | 5 | 0 | t | 1000 | 148800 | 0 | 9025 | 0 |
...
|---|---|---:|---:|---:|---:|---:|---:|---:|
| metrics_date | chunk | 58 | 475136 | 118 | 118 | 0 |  |  |
| metrics_date | compressed | 58 | 950272 | 0 | 3 | 3 |  |  |
| metrics_tstz | chunk | 58 | 475136 | 119 | 119 | 0 |  |  |
| metrics_tstz | compressed | 58 | 950272 | 0 | 3 | 3 |  |  |

## Load, compression and continuous aggregate

| table | phase | seconds | rows | rows/sec |
|---|---|---:|---:|---:|
| metrics_date | cagg_refresh | 0.84 | 80000 | 95348 |
| metrics_tstz | cagg_refresh | 0.82 | 80000 | 97009 |
| metrics_date | compress | 2.11 | 1920000 | 907855 |
| metrics_tstz | compress | 2.33 | 1920000 | 822356 |
| metrics_date | load | 3.99 | 1920000 | 481390 |
| metrics_tstz | load | 4.95 | 1920000 | 387644 |

## Storage, whole table

| table | rows | heap before | index before | total before | bytes/row before | total after | bytes/row after | ratio |
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| metrics_date | 1920000 | 152 MB | 13 MB | 166 MB | 90.71 | 53 MB | 28.70 | 3.16 |
...
| metrics_date | status | text | 8961555 | 4.667 | 1314600 | 0.685 | 6.82 | 11600 | 165.5 |
| metrics_date | v1 | double precision | 15360000 | 8.000 | 13351272 | 6.954 | 1.15 | 11600 | 165.5 |
| metrics_date | v2 | double precision | 15360000 | 8.000 | 14837896 | 7.728 | 1.04 | 11600 | 165.5 |
| metrics_date | v3 | integer | 7680000 | 4.000 | 2657696 | 1.384 | 2.89 | 11600 | 165.5 |
| metrics_date | (columns) |  | 85761555 | 44.667 | 36183760 | 18.846 | 2.37 |  |  |
| metrics_date | (heap) |  | 159621120 | 83.136 | 6160384 | 3.209 | 25.91 |  |  |
| metrics_date | (index) |  | 14057472 | 7.322 | 950272 | 0.495 | 14.79 |  |  |
| metrics_date | (toast) |  | 475136 | 0.247 | 47988736 | 24.994 | 0.01 |  |  |
| metrics_date | (total) |  | 174153728 | 90.705 | 55099392 | 28.698 | 3.16 |  |  |
...
| metrics_tstz | status | text | 8961555 | 4.667 | 1314600 | 0.685 | 6.82 | 11600 | 165.5 |
| metrics_tstz | ts | timestamp with time zone | 15360000 | 8.000 | 2976200 | 1.550 | 5.16 | 11600 | 165.5 |
| metrics_tstz | v1 | double precision | 15360000 | 8.000 | 13351272 | 6.954 | 1.15 | 11600 | 165.5 |
| metrics_tstz | v2 | double precision | 15360000 | 8.000 | 14837896 | 7.728 | 1.04 | 11600 | 165.5 |
| metrics_tstz | v3 | integer | 7680000 | 4.000 | 2657696 | 1.384 | 2.89 | 11600 | 165.5 |
| metrics_tstz | (columns) |  | 93441555 | 48.667 | 38100560 | 19.844 | 2.45 |  |  |
