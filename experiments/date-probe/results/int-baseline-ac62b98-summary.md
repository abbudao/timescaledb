# DATE probe: variant `int-baseline` @ ac62b98

run_id `int-baseline-ac62b98-20260922T114909Z`, scale `small`, TimescaleDB 2.31.0-dev on PostgreSQL 16.15 (Ubuntu 16.15-0ubuntu0.24.04.1), started 2026-09-22 11:49 UTC
...
|---|---|---:|---:|---:|---:|---|---:|---:|---:|---:|---:|
| Q1 | metrics_date | 22.52 | 4.40 | 58 | 0 | f | 1 | 144000 | 2 | 6401 | 0 |
| Q1 | metrics_tstz | 5.90 | 0.49 | 5 | 0 | t | 1 | 144000 | 0 | 6025 | 0 |
| Q1-np | metrics_date | 14.84 | 3.69 | 58 | 0 | f | 1 | 144000 | 0 | 6319 | 0 |
| Q1-np | metrics_tstz | 5.82 | 0.46 | 5 | 0 | t | 1 | 144000 | 0 | 6025 | 0 |
| Q2 | metrics_date | 14.01 | 3.66 | 5 | 53 | t | 1 | 148800 | 2 | 6025 | 0 |
| Q2 | metrics_tstz | 14.42 | 4.48 | 5 | 53 | t | 1 | 148800 | 2 | 6025 | 0 |
| Q2-np | metrics_date | 6.18 | 3.05 | 5 | 53 | t | 1 | 148800 | 0 | 6025 | 0 |
| Q2-np | metrics_tstz | 6.35 | 4.51 | 5 | 53 | t | 1 | 148800 | 0 | 6025 | 0 |
| Q3 | metrics_date | 4.89 | 0.43 | 5 | 0 | t | 1 | 148800 | 0 | 4225 | 0 |
| Q3 | metrics_tstz | 4.54 | 0.36 | 5 | 0 | t | 1 | 148800 | 0 | 4225 | 0 |
| Q3-np | metrics_date | 5.15 | 0.74 | 5 | 0 | t | 1 | 148800 | 0 | 4225 | 0 |
| Q3-np | metrics_tstz | 4.98 | 0.34 | 5 | 0 | t | 1 | 148800 | 0 | 4225 | 0 |
| Q4 | metrics_date | 21.92 | 0.53 | 5 | 0 | t | 1000 | 148800 | 0 | 9025 | 0 |
| Q4 | metrics_tstz | 16.22 | 0.45 | 5 | 0 | t | 1000 | 148800 | 0 | 9025 | 0 |
| Q4-np | metrics_date | 22.38 | 0.52 | 5 | 0 | t | 1000 | 148800 | 0 | 9025 | 0 |
| Q4-np | metrics_tstz | 17.00 | 0.52 | 5 | 0 | t | 1000 | 148800 | 0 | 9025 | 0 |
| Q5 | metrics_date | 0.04 | 0.45 | 1 | 0 | t | 24 | 24 | 0 | 23 | 0 |
| Q5 | metrics_tstz | 0.04 | 0.14 | 1 | 0 | t | 24 | 24 | 0 | 23 | 0 |
| Q5-np | metrics_date | 0.04 | 0.17 | 1 | 0 | t | 24 | 24 | 0 | 23 | 0 |
| Q5-np | metrics_tstz | 0.04 | 0.14 | 1 | 0 | t | 24 | 24 | 0 | 23 | 0 |
...
|---|---|---:|---:|---:|
| metrics_date | cagg_refresh | 0.93 | 80000 | 85598 |
| metrics_tstz | cagg_refresh | 0.85 | 80000 | 94610 |
| metrics_date | compress | 1.99 | 1920000 | 963212 |
| metrics_tstz | compress | 2.37 | 1920000 | 811018 |
| metrics_date | load | 3.87 | 1920000 | 496434 |
| metrics_tstz | load | 4.88 | 1920000 | 393633 |

## Storage, whole table

| table | rows | heap before | index before | total before | bytes/row before | total after | bytes/row after | ratio |
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| metrics_date | 1920000 | 152 MB | 13 MB | 166 MB | 90.71 | 52 MB | 28.65 | 3.17 |
...
| metrics_date | status | text | 8958789 | 4.666 | 1314600 | 0.685 | 6.81 | 11600 | 165.5 |
| metrics_date | v1 | double precision | 15360000 | 8.000 | 13350360 | 6.953 | 1.15 | 11600 | 165.5 |
| metrics_date | v2 | double precision | 15360000 | 8.000 | 14838744 | 7.729 | 1.04 | 11600 | 165.5 |
| metrics_date | v3 | integer | 7680000 | 4.000 | 2658176 | 1.384 | 2.89 | 11600 | 165.5 |
| metrics_date | (columns) |  | 85758789 | 44.666 | 36184176 | 18.846 | 2.37 |  |  |
| metrics_date | (heap) |  | 159621120 | 83.136 | 6160384 | 3.209 | 25.91 |  |  |
| metrics_date | (index) |  | 14057472 | 7.322 | 950272 | 0.495 | 14.79 |  |  |
| metrics_date | (toast) |  | 475136 | 0.247 | 47906816 | 24.951 | 0.01 |  |  |
| metrics_date | (total) |  | 174153728 | 90.705 | 55017472 | 28.655 | 3.17 |  |  |
...
| metrics_tstz | status | text | 8958789 | 4.666 | 1314600 | 0.685 | 6.81 | 11600 | 165.5 |
| metrics_tstz | ts | timestamp with time zone | 15360000 | 8.000 | 2976200 | 1.550 | 5.16 | 11600 | 165.5 |
| metrics_tstz | v1 | double precision | 15360000 | 8.000 | 13350360 | 6.953 | 1.15 | 11600 | 165.5 |
| metrics_tstz | v2 | double precision | 15360000 | 8.000 | 14838744 | 7.729 | 1.04 | 11600 | 165.5 |
| metrics_tstz | v3 | integer | 7680000 | 4.000 | 2658176 | 1.384 | 2.89 | 11600 | 165.5 |
| metrics_tstz | (columns) |  | 93438789 | 48.666 | 38100976 | 19.844 | 2.45 |  |  |
